...
| **10** | M 3/17 | Hypothesis Testing and Decision Errors & <br>**Homework 3** |
|  | W 3/19 | Inference for Proportions |
|  | F 3/21 | Inference for Means |
| **11** | M 3/24 | Choosing Tests for Parameter Estimations & <br>**Project Phase 3** |
|  | W 3/26 | Rank-Based Tests |
|  | F 3/28 | Chi-Squared Tests |
| **12** | M 3/31 | Hypothesis Testing for Proportions and Means |
|  | W 4/2 | Linear Regression and Least-Squares, & <br>Residual Analysis |
|  | F 4/4 | Multiple Linear Regression |
| **13** | M 4/7 | Hypothesis Testing for Linear Regression & <br>**Homework 4** |
|  | W 4/9 | Inference for Many Means |
|  | F 4/11 | ANalysis Of VAriance (ANOVA) |
| **14** | M 4/14 | Choosing Hypothesis Tests & <br>**Project Phase 4** |
...
| Inference for Means | TBA |
| Choosing Tests for Parameter Estimations | TBA |
| Rank-Based Tests | TBA |
| Chi-Squared Tests | TBA |
| Hypothesis Testing for Proportions and Means | TBA |
| Linear Regression and Least-Squares, & <br>Residual Analysis | TBA |
| Multiple Linear Regression | TBA |
| Hypothesis Testing for Linear Regression | TBA |
| Inference for Many Means | TBA |
| ANalysis Of VAriance (ANOVA) | TBA |
| Choosing Hypothesis Tests | TBA |
