...
| **7** | M 2/24 | Conditional Probability & <br>**Homework 3** & <br>**Project Phase 2** |
...
| **9** | M 3/10 | Parameter Estimation & <br>**Homework 4** |
|  | W 3/12 | Hypothesis Testing |
|  | F 3/14 | Bootstrapping and Randomizations |
| **10** | M 3/17 | Decision Errors & <br>**Homework 5** |
...
| Advanced Visualizations & <br>Exploring Categorical Data | ch. 6.5-6.7 & ch. 7.4 @speegle2021probability |
...
## Groups^[Group names are inspired by *Avatar: The Last Airbender* and *Legend of Korra* seasons.]

| **Name** | **Water** | **Earth** | **Fire** | **Air** | **Spirits** | **Change** |
|---:|:---:|:---:|:---:|:---:|:---:|:---:|
| **Members** | GraceD<br>IhlaraW | RuthS<br>EduardoG | KalynaB<br>JacqulynneS | MaiaS<br>SydneyL | CalvinP<br>GabeM | HassanE<br>JohnA |
| **Final Data Set** | `conversation` | `military` | *TBD* | *TBD* | `chimps` | `pres_election` |
