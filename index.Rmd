...
|  | F 1/31 | Basics of Visualizations & Exploring Numerical Data |
| **4** | M 2/3 | Study Design & <br>Inference & <br>**Homework 1** & <br>**Project Phase 1** |
|  | W 2/5 | Probability & <br>Random Variables |
|  | F 2/7 | Probability Functions & <br>Expected Value and Variance |
| **5** | M 2/10 | Random Sampling |
|  | W 2/12 | Discrete Random Variables & <br>Probability Mass Functions |
|  | F 2/14 | Binomial and Geometric Distributions |
| **6** | M 2/17 | Simulating Discrete Random Variables & <br>**Homework 2** |
|  | W 2/19 | Continuous Random Variables & <br>Probability Density Functions |
|  | F 2/21 | Normal and Exponential Distributions |
| **7** | M 2/24 | Exploring Categorical Data & <br>**Homework 3** & <br>**Project Phase 2** |
|  | W 2/26 | Law of Large Numbers |
...
|  | W 3/12 | Estimation and Variability |
|  | F 3/14 | Decision Errors |
...
| [Study Design & Inference](lessons/4.1-mth361-study-design-and-inference/4.1-mth361-study-design-and-inference.html) | - |
| [Probability & <br>Random Variables](lessons/4.2-mth361-probability-and-random-variables/4.2-mth361-probability-and-random-variables.html) | ch. 2.1 & ch. 2.3-2.4 @speegle2021probability |
| [Probability Functions & <br>Expected Value and Variance](lessons/4.3-mth361-probability-functions-and-expected-value-and-variance/4.3-mth361-probability-functions-and-expected-value-and-variance.html) | - |
| [Random Sampling](lessons/5.1-mth361-random-sampling/5.1-mth361-random-sampling.html) | ch. 2.2 @speegle2021probability |
...
| Binomial and Geometric Distributions | ch. 3.3-3.4 @speegle2021probability |
| Simulating Discrete Random Variables | ch. 5.2 |
| Continuous Random Variables & <br>Probability Density Functions | ch. 4.1-4.3 @speegle2021probability |
| Normal and Exponential Distributions | ch. 4.4-4.5 @speegle2021probability |
| Exploring Categorical Data | ch. 6.5-6.7 & ch. 7.4 @speegle2021probability |
| Law of Large Numbers | ch. 5.1 @speegle2021probability |
| Central Limit Theorem | ch. 5.4 @speegle2021probability |
| Simulating Continuous Random Variables | ch. 5.3 @speegle2021probability |
| Estimation and Variability | - |
| Decision Errors | - |
| Estimating Sampling Distributions | ch. 5.5-5.6 @speegle2021probability |
