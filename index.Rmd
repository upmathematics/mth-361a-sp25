...
|  | W 1/22 | R Markdown |
|  | F 1/24 | Data Principles |
| **3** | M 1/27 | Data Processing and Visualizations & <br>**Homework 1** |
|  | W 1/29 | Study Design |
|  | F 1/31 | Inference |
| **4** | M 2/3 | Exploring Numerical Data & <br>**Project Phase 1** |
...
| R Markdown | - |
| Data Principles | ch. 1.5-1.8 @speegle2021probability |
| Data Processing and Visualizations | ch. 6.1-6.4 & ch. 7.1 @speegle2021probability |
| Study Design | - |
| Inference | - |
