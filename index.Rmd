...
> You are encouraged to participate in discussions with your peers regarding worksheets and homeworks. However, each student must take responsibility and ownership of their work and submit their work individually.
...
> There are 5 Project Phases, 7 Homeworks, and 26 Worksheets. So, you should be able to know where you stand in this course and plan on how to improve your learning accordingly.
...
|  | F 1/17 | Introduction to R and R Studio | - |
| **2** | M 1/20 | _MLK Day (no classes, offices closed)_ | - |
|  | W 1/22 | Introduction to R Markdown | - |
|  | F 1/24 | Advanced Data Strategies and Principles | TBA |
| **3** | M 1/27 | Data Processing and Visualizations & <br>**Homework 1** | - |
|  | W 1/29 | Basic Probability | - |
|  | F 1/31 | Conditional Probability | TBA |
| **4** | M 2/3 | **Project Phase 1** | - |
|  | W 2/5 | Random Variables & <br>Probability Functions | TBA |
|  | F 2/7 | Expected Value and Variance | TBA |
...
|  | W 3/12 | Inference Fundamentals | TBA |
