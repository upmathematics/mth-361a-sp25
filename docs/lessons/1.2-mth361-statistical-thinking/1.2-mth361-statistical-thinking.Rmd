...
* **Data Handling:**
  ...
  - Understand & manipulate diverse data structures (e.g., vectors, matrices, data frames)
  - Master data collection methods & their limitations
  - Visualize data effectively (charts, plots)
  - Calculate key statistical properties (mean, median, standard deviation)
::::

:::: {.column width=48%}
* **Modeling:**
  - Apply linear regression models appropriately
  - Interpret model results in real-world contexts
::::
...
* **Probability & Inference:**
  ...
  - Grasp fundamental concepts of probability & random variables
  - Perform statistical inference (hypothesis testing, confidence intervals, estimation)
  - Critically evaluate claims & decisions based on data
::::

:::: {.column width=48%}
* **R Programming:**
  - Develop & execute basic R code for data analysis, modeling, & visualization
  
* **Communication:**
  
  - Produce detailed written reports demonstrating strong understanding of data analysis, modeling, & inference
::::
