...
3. Enter the Workspace using the link in the email sent from Posit Cloud, then click on the assignment named *Calculator Alex Q*. This will create a copy for you.

4. Rename your copied assignment as *Calculator [First name] [First letter of last name]*.
