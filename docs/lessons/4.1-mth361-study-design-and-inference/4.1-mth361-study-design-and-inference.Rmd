...
3. Choose top 3 data sets in the [Project Data Sets](){target="_blank"}. Install and load the necessary packages, then look at the information about the data set you have chosen by using the `?` command. For example, `?iris` outputs information about the `iris` data frame. 
