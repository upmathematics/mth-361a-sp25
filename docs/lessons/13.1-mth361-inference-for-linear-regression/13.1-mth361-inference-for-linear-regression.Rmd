...
- **Activity: Determine Confidence Intervals of Linear Model**
::::
...
```{r message=FALSE, warning=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=6,fig.height=3}
...
We can conclude that we are 95% confident that the true slope that models the spending amount on advertising versus revenue is 4.36 to 5.23.
