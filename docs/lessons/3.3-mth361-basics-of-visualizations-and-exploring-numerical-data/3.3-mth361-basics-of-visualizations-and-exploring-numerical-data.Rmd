...
* Descriptive Statistics: Measures of center (mean, median, mode) and spread (range, variance, standard deviation)
* Distribution Shapes: Symmetric, skewed, uniform, normal
...
* Data exploration helps detect patterns, trends, and anomalies
* Choosing the right visualization is crucial for interpretation
* Summary statistics provide insights into central tendency and variability

::: {style="color: red"}
$\star$ This are the general ideas on exploring numerical variables. *We will discuss the definitions, details, and examples soon.*
:::
