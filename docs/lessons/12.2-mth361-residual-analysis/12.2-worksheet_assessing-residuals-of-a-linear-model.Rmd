...
```{r x-y-scatterplot, fig.cap = "Scatterplot of variables x and y. The red line is the best fit linear model of the data.", out.width="35%", message=FALSE, warning=FALSE, fig.align='center', fig.width=4,fig.height=4}
