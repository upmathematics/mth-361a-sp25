...
The sample mean of $0.88$ is not exactly equal to the expected value of $1$ due to sampling variability. By the Law of Large Numbers, we know that as we increase the number of samples, the sample mean gets closer to the expectation.
...
$$
\begin{aligned}
P(X=4) & = \binom{10}{4} (0.50)^4 (1-0.50)^{n-k} \\ 
       & \approx 0.205
\end{aligned}
$$
...
The sample mean of $4.74$ is not exactly equal to the expected value of $5$ due to sampling variability. By the Law of Large Numbers, we know that as we increase the number of samples, the sample mean gets closer to the expectation.
