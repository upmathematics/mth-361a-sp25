...
\vfill
b. Count the number of $\mathcal{T}$s in each outcome in Part (i).
\vfill
...
\vfill
b. Add the numbers of the dice in each outcome in Part (i). Then count the frequency of each possible sum.
\vfill
