...
## Example: Subset a Data Frame based on Conditions
...
**Case Example:** The following code sequence subsets the `iris` dataframe (in tibble form) to include only the "versicolor" species, and all rows with `Sepal.Length` at least $6$. 
